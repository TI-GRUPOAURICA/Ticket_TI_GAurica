...
import EquiposCelulares from "./pages/EquiposCelulares";
...
export default function App() {
  ...
  const [viendoSeguimiento, setViendoSeguimiento] =
    useState(false);
  ...
  const renderPage = () => {
    ...
    switch (currentPage) {
      ...
      case "equipos-celulares":

        return <EquiposCelulares />;

      // NUEVO: Cuentas de correo
      case "cuentas-correo":
